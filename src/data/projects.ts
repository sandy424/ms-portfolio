...
export const projects: ProjectType[] = [
  ...
  },
  {
    ...
    why: "맛집 정보가 여러 채널에 흩어져 있다 보니, 디저트를 좋아하는 사람들이 지도 위에서 한눈에 원하는 가게를 찾기 어렵다는 불편함에서 시작했습니다. 지도 기반으로 디저트 가게를 탐색하고 기록할 수 있는 서비스를 목표로 했습니다.",
    features: [
    ...
    retrospect: "Firebase를 처음 도입하면서 러닝커브를 과소평가했던 점이 아쉬웠습니다. 다음에는 새 기술 스택을 쓰기 전에 공식 문서로 데이터 모델링을 먼저 설계하고 시작하려 합니다.",
  },
];
